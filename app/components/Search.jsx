...
export default function Search() {
  return (
    <div className="relative  text-gray-500 dark:text-gray-100 hidden lg:block">
      <input
        className=" bg-white border-2 border-transparent focus:border-slate-200 dark:focus:border-slate-700
        dark:bg-slate-700  h-10 px-5 rounded-lg text-sm focus:outline-none"
        type="search"
        name="search"
        placeholder="Search"
      />
