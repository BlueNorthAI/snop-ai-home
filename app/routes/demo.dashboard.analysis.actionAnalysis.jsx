...
import { kpiService_m, kpiInv_m } from "~/data/analysis/actionData";
  ...
  return (
    <>
      <div className="w-full h-screen">
        ...
        <div>
          <div className="mx-4 my-2 k-grid k-grid-cols-4 gap-6">
            {stats.map((item) => (
              <div
                key={item.name}
                className="items-center overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6"
              >
                <p className="truncate text-center text-lg font-medium text-gray-500">
                  {item.name}
                </p>
                <span className="mt-1 text-center text-4xl font-bold tracking-tight  text-gray-900  lg:text-5xl">
                  {item.stat}
                </span>
              </div>
            ))}
        ...
        <ul className="mx-4 my-4 p-1 grid grid-cols-1 md:grid-cols-2 rounded-lg bg-white shadow-xl shadow-slate-900/10">
...
*/}
        ...
        {/* <ul className="mx-4 my-4 p-1 grid grid-cols-2 rounded-lg bg-white shadow-xl shadow-slate-900/10">
          {kpiInv_m.map((kpi) => (
            <li
              key={kpi.Name}
              className="col-span-1 flex flex-col divide-y divide-white"
