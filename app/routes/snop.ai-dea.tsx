...
import { columns } from "../components/columns-idea";
import { DataTable } from "../components/data-table-idea";
import { UserNav } from "../components/user-nav-inc";
import { taskSchema } from "../data/ideadata/schema";
import taskData from "../data/ideadata/tasks.json";
