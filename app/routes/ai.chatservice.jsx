...
import { kpiChat } from "~/data/analysis/serviceData";
        ...
        <div className="flex h-screen w-full flex-col items-center bg-white">
          ...
          w-full flex-col relative  bg-white p-4 shadow rounded-lg "
                >
                  ...
                  <ul className="p-4 grid grid-cols-1 gap-2 k-list-disc">
                    <li>1</li>
                    <li>1</li>
                    <li>1</li>
                  </ul>

                  <ul className="grid grid-cols-1 gap-6 md:grid-cols-2 rounded-lg  p-4">
                    {kpiChat.map((kpi) => (
                      <li
                        key={kpi.Name}
                  ...
                  <div className="pt-2">
                    <div className="m-2 h-10 flex justify-between">
                      <Button
                        className="k-bg-inverse flex-1  mx-2 text-white"
                        variant="outline"
                      >
                        <WrenchScrewdriverIcon
                          className="h-5 w-5 "
