...
const navigation = [
  { name: "Operating Expense Analysis", href: "/snop/dashboard/analysis/opexpenseAnalysis", current: false },
  { name: "Profit Analysis", href: "/snop/dashboard/analysis/profitAnalysis", current: true },
];
