...
const navigation = [
  { name: "Operating Expense Analysis", href: "/snop/dashboard/analysis/opexpenseAnalysis", current: true },
  { name: "Profit Analysis", href: "/snop/dashboard/analysis/profitAnalysis", current: false },
