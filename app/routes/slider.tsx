  ...
  return (
    ...
    <Hero />
      <div className="flex h-24 w-full items-center justify-center">
        ...
        <h1 className="max-w-2xl font-display text-5xl tracking-tight text-slate-900 dark:text-white ">
          Our Capabilities
        </h1>
      </div>
      ...
      <div className="relative flex w-full flex-auto justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="sticky top-[4.75rem] -ml-0.5 h-[calc(100vh-4.75rem)] w-96 overflow-y-auto overflow-x-hidden py-16 pl-0.5 pr-8 xl:w-72 xl:pr-16">
            <Navigation />
          </div>
        </div>
