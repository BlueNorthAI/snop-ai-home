...
const navigation = [
  { name: "Supply Analysis", href: "/snop/dashboard/analysis/supplyAnalysis", current: true },
  ...
  { name: "Procure to Pay", href: "/snop/dashboard/analysis/procureAnalysis", current: false },
];
