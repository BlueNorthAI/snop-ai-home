...
const navigation = [
  { name: "Supply Analysis", href: "/snop/dashboard/analysis/supplyAnalysis", current: false },
  { name: "Savings Analysis", href: "/snop/dashboard/analysis/savingsAnalysis", current: false },
  { name: "Procurement Efficinecy", href: "/snop/dashboard/analysis/proeffAnalysis", current: false },
  { name: "Spend Analysis", href: "/snop/dashboard/analysis/spendAnalysis", current: false },
  { name: "Procure to Pay", href: "/snop/dashboard/analysis/procureAnalysis", current: true },
];
