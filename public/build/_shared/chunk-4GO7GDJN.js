...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1710611124948.0388";
}
function ThemeSelector() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DropdownMenu, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "flex h-10 w-10 items-center justify-center rounded-xl shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-slate-800 dark:ring-inset dark:ring-white/5 dark:text-sky-500 text-sky-500 ", "aria-label": "Theme", children: [
...
//# sourceMappingURL=/build/_shared/chunk-4GO7GDJN.js.map
