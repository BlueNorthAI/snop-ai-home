...
// app/routes/snop.scenario_.$scenId_.analyze copy.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\snop.scenario_.$scenId_.analyze copy.tsx"' + id);
  };
...
function DemoContainer({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: cn("flex items-center justify-center [&>div]:w-full bg-gradient-to-t from-indigo-400 via-cyan-400 to-sky-500 p-0.5 rounded-xl ", className), ...props }, void 0, false, {
    fileName: "app/routes/snop.scenario_.$scenId_.analyze copy.tsx",
    lineNumber: 67,
    columnNumber: 10
  }, this);
}
...
//# sourceMappingURL=/build/routes/snop.scenario_.$scenId_.analyze copy-I4OLGGLC.js.map
