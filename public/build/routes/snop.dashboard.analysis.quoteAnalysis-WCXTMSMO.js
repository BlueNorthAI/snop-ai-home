...
// app/kendo/rawData/analysis/quoteAnalysis.js
if (import.meta) {
...
var ownerCategories_m = ["Gaberielle", "Quinn", "Lennox", "Rory"];
var ownerSeries_m = [
  {
    name: "Open",
    data: [50, 10, 10, 10]
  ...
  {
    name: "Won",
    data: [3e3, 2e3, 1500, 1e3]
  },
  {
    name: "Lost",
    data: [9e3, 7e3, 5e3, 4e3]
  }
];
var avgContCategories_m = ["May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb"];
var avgContSeries_m = [
  {
    name: "Created",
    data: [100, 50, 50, 50, 10, 0, 0, 0, 0, 0]
  },
  {
    name: "Ordered",
    data: [3e3, 2e3, 1500, 1500, 100, 1e3, 1e3, 500, 50, 0]
  },
  {
    name: "Rejected",
    data: [9e3, 7e3, 5e3, 3e3, 3e3, 4e3, 2e3, 500, 50, 0]
  }
];
var quoteCategories_m = ["May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar"];
var quoteSeries_m = [
  {
    name: "",
    data: [7e3, 4e3, 3e3, 2e3, 1500, 1e3, 1e3, 700, 400, 5e3, 1e3]
  }
];
var lineCategories_m = [
  "Assembly Plant",
  "Corporate",
  "Corporate Servies",
  "Distribution",
...
// app/data/analysis/quoteData.js
...
var kpiService_m = [
  {
    ...
    container: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WrapperMultiStackColChart, { category: ownerCategories_m, series: ownerSeries_m }, void 0, false, {
      fileName: "app/data/analysis/quoteData.js",
      lineNumber: 40,
      columnNumber: 16
    }, this)
  },
  {
    ...
    container: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WrapperMultiStackColChart, { category: avgContCategories_m, series: avgContSeries_m }, void 0, false, {
      fileName: "app/data/analysis/quoteData.js",
      lineNumber: 44,
      columnNumber: 16
    }, this)
  },
  {
    ...
    container: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WrapperMultiColumnChart, { category: quoteCategories_m, series: quoteSeries_m }, void 0, false, {
      fileName: "app/data/analysis/quoteData.js",
      lineNumber: 49,
      columnNumber: 16
    }, this)
  },
  {
    ...
    container: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WrapperMultiColumnChart, { category: lineCategories_m, series: lineSeries_m }, void 0, false, {
      fileName: "app/data/analysis/quoteData.js",
      lineNumber: 54,
      columnNumber: 16
    }, this)
...
// app/routes/snop.dashboard.analysis.quoteAnalysis.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\snop.dashboard.analysis.quoteAnalysis.jsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711092386318.3484";
}
var navigation = [{
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "bg-white", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(qe2.Root, { show: open, as: import_react.Fragment, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(_t, { as: "div", className: "relative z-40 sm:hidden", onClose: setOpen, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(qe2.Child, { as: import_react.Fragment, enter: "transition-opacity ease-linear duration-300", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "transition-opacity ease-linear duration-300", leaveFrom: "opacity-100", leaveTo: "opacity-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "fixed inset-0 bg-black bg-opacity-25" }, void 0, false, {
          fileName: "app/routes/snop.dashboard.analysis.quoteAnalysis.jsx",
          lineNumber: 182,
          columnNumber: 15
        }, this) }, void 0, false, {
          fileName: "app/routes/snop.dashboard.analysis.quoteAnalysis.jsx",
...
_s(QuoteAnalysisRoute, "xG1TONbKtDWtdOTrXaTAsNhPg/Q=");
_c = QuoteAnalysisRoute;
var _c;
$RefreshReg$(_c, "QuoteAnalysisRoute");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  QuoteAnalysisRoute as default
};
//# sourceMappingURL=/build/routes/snop.dashboard.analysis.quoteAnalysis-WCXTMSMO.js.map
