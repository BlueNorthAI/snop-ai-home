import {
  ...
  priorities,
  statuses
} from "/build/_shared/chunk-WY5CVEBA.js";
import "/build/_shared/chunk-PUWGFPGF.js";
...
import "/build/_shared/chunk-TT7DNJ63.js";
...
import "/build/_shared/chunk-WMPYSF63.js";
...
var columns = [
  {
    ...
    header: ({ table }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      ...
      false,
      {
        fileName: "app/components/columns-inci.tsx",
        lineNumber: 26,
        columnNumber: 7
      },
      this
  ...
  {
    accessorKey: "id",
    header: ({ column }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DataTableColumnHeader, { column, title: "Action" }, void 0, false, {
      fileName: "app/components/columns-inci.tsx",
      lineNumber: 47,
      columnNumber: 7
    }, this),
  ...
  },
  {
    ...
    header: ({ column }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DataTableColumnHeader, { column, title: "Priority" }, void 0, false, {
      fileName: "app/components/columns-inci.tsx",
      lineNumber: 83,
      columnNumber: 7
    }, this),
...
function DataTableToolbar({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-1 items-center space-x-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Input, { placeholder: "Filter Actions...", value: table.getColumn("title")?.getFilterValue() ?? "", onChange: (event) => table.getColumn("title")?.setFilterValue(event.target.value), className: "h-8 w-[150px] lg:w-[250px]" }, void 0, false, {
        fileName: "app/components/data-table-toolbar-inci.tsx",
        lineNumber: 33,
        columnNumber: 9
      }, this),
...
function DataTable({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "space-y-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(DataTableToolbar, { table }, void 0, false, {
      fileName: "app/components/data-table-inci.tsx",
      lineNumber: 58,
      columnNumber: 7
    }, this),
...
function TaskPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_jsx_dev_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "m-2", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mx-2 py-3.5 rounded-t-lg bg-sky-500 border-b ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("nav", { className: "ml-6 pl-6 flex items-center justify-center", "aria-label": "Global", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: " flex gap-x-8 justify-center ", children: navigation.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Link, { to: item.to, className: " text-base lg:text-lg font-semibold leading-6 text-white hover:text-gray-200", children: item.name }, item.id, false, {
      fileName: "app/routes/snop.incidents.tsx",
      lineNumber: 85,
      columnNumber: 39
    }, this)) }, void 0, false, {
      fileName: "app/routes/snop.incidents.tsx",
...
//# sourceMappingURL=/build/routes/snop.incidents-ZKBXRBUL.js.map
