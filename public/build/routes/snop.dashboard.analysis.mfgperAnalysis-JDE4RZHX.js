...
// app/kendo/rawData/analysis/mfgperAnalysis.js
if (import.meta) {
...
var volumeCategories_m = ["USA Manufacturing", "Canada Manufacturing", "Mexico Manufacturing", "Brazil Manufacturing", "France Manufacturing", "Germany Manufacturing", "Japan Manufacturing"];
var volumeSeries_m = [
  {
    name: "",
    data: [35, 30, 15, 2, 6, 5, 3]
  }
];
var uptimeCategories_m = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug"];
var uptimeSeries_m = [
  {
    name: "Quality Assurance",
    data: [20, 20, 21, 20, 20, 20, 20, 20]
  },
  {
    name: "Production",
    data: [20, 20, 21, 20, 20, 20, 20, 20]
...
var trendCategories_m = ["May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
var trendSeries_m = [
  {
    name: "M1",
    data: [3, 9, 6, 9, 3, 2, 3, 3]
  },
  {
    name: "M2",
    data: [2, 6, 3, 2, 3, 3, 6, 15]
  },
  {
    name: "M3",
    data: [9, 2, 10, 3, 6, 9, 2, 9]
  }
];
...
// app/data/analysis/mfgperData.js
...
var kpiService_m = [
  {
    ...
    container: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WrapperMultiBarChart, { category: volumeCategories_m, series: volumeSeries_m }, void 0, false, {
      fileName: "app/data/analysis/mfgperData.js",
      lineNumber: 35,
      columnNumber: 16
    }, this)
  },
  {
    ...
    container: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WrapperMultiStackColChart, { category: uptimeCategories_m, series: uptimeSeries_m }, void 0, false, {
      fileName: "app/data/analysis/mfgperData.js",
      lineNumber: 39,
      columnNumber: 16
    }, this)
...
// app/routes/snop.dashboard.analysis.mfgperAnalysis.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\snop.dashboard.analysis.mfgperAnalysis.jsx"' + id);
  };
...
var stats = [{
  ...
  name: "Overall Operations Effectiveness(OOE)",
  stat: "73%"
}, {
  name: "Overall Equipment Effectiveness(OOE)",
  stat: "$451.2K"
}];
var activeFilters = [{
  value: "objects",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "bg-white", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(qe2.Root, { show: open, as: import_react.Fragment, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(_t, { as: "div", className: "relative z-40 sm:hidden", onClose: setOpen, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(qe2.Child, { as: import_react.Fragment, enter: "transition-opacity ease-linear duration-300", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "transition-opacity ease-linear duration-300", leaveFrom: "opacity-100", leaveTo: "opacity-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "fixed inset-0 bg-black bg-opacity-25" }, void 0, false, {
          fileName: "app/routes/snop.dashboard.analysis.mfgperAnalysis.jsx",
          lineNumber: 180,
          columnNumber: 15
        }, this) }, void 0, false, {
          fileName: "app/routes/snop.dashboard.analysis.mfgperAnalysis.jsx",
...
_s(MfgperAnalysisRoute, "xG1TONbKtDWtdOTrXaTAsNhPg/Q=");
_c = MfgperAnalysisRoute;
var _c;
$RefreshReg$(_c, "MfgperAnalysisRoute");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  MfgperAnalysisRoute as default
};
//# sourceMappingURL=/build/routes/snop.dashboard.analysis.mfgperAnalysis-JDE4RZHX.js.map
